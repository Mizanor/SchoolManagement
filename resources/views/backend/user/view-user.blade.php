              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$key+1}}</td>
                      <td> <img id="showImage" src="{{(!empty($user->image))?url('public/upload/user_images/'.$user->image):url('public/upload/no_images.png')}}" style="width: 100px; height: 110px; border: 1px solid #000;"></td>
                      <td>{{$user->role}}</td>
                      <td>{{$user->name}}</td>
                      <td>{{$user->email}}</td>
                      <td>{{$user->code}}</td>
