				...
				<table width="80%">
					<tr>
						...
						<td class="text-center">
							<img src="{{(!empty($totalattendgroupbyid['0']['user']['image']))?url('public/upload/employee_images/'.$totalattendgroupbyid['0']['user']['image']):url('public/upload/no_images.png')}}" style="width: 70px; height: 70px; border: 1px solid #000;">
						</td>
					</tr>
