                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="{{$value->id}}">
                      ...
                      <td><img src="{{(!empty($value['student']['image']))?url('public/upload/student_images/'.$value['student']['image']):url('public/upload/no_images.png')}}" style="width: 60px; height: 65px; border: 1px solid #000;"></td>
                      @if(Auth::user()->role=="Admin")
                  ...
                  <tbody>
                    ...
                    <tr class="{{$value->id}}">
                      ...
                      <td>
                        <a title="Edit" class="btn btn-sm btn-primary" href="{{route('students.registration.edit', $value->student_id)}}"><i class="fa fa-edit"></i></a>
                        <a title="Promotion" class="btn btn-sm btn-success" href="{{route('students.registration.promotion', $value->student_id)}}"><i class="fa fa-check"></i></a>
                        <a target="_blank" title="Details" class="btn btn-sm btn-info btn-sm" href="{{route('students.registration.details', $value->student_id)}}"><i class="fa fa-eye"></i></a>
                      </td>
                    </tr>
                     @endforeach
