              ...
              <div class="card-body">
                <form method="POST" action="{{route('marks.store')}}" id="myForm">
                  ...
                  <div class="row d-none" id="marks-entry" >
                    <div class="col-md-12">
                      <table class="table table-bordered table-striped dt-responsive table2" style="width:100%">
                        <thead>
                          <tr>
                            <th>ID No</th>
                            <th>Student Name</th>
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          $.each(data, function( key, v ){
            ...
            '<td><input type="text" class="form-control form-control-sm writen" name="writen[]"></td>'+
            '<td><input type="text" class="form-control form-control-sm" name="mcq[]"></td>'+
            '<td><input type="text" class="form-control form-control-sm" name="practical[]"></td>'+
            '</tr>';
