...
class StudentRegController extends Controller
{
    public function view(){
    	...
    	$data['allData'] = AssignStudent::where('year_id',$data['year_id'])->where('class_id',$data['class_id'])->where('shift_id',$data['shift_id'])->get();
    ...
    public function YearClassWise(Request $request){
    	...
    	$data['allData'] = AssignStudent::where('year_id',$request->year_id)->where('class_id',$request->class_id)->where('shift_id',$request->shift_id)->get();
    	return view('backend.student.student_reg.view-student',$data);
    }
