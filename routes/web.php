...
Route::prefix('setups')->group(function(){
	...
	Route::post('/student/shift/update/{id}', 'Backend\Setup\ShiftController@update')->name('setups.student.shift.update');
	  ...
	  //Student Fee
	Route::get('/fee/category/view', 'Backend\Setup\FeeController@view')->name('setups.fee.category.view');
	Route::get('/fee/category/add', 'Backend\Setup\FeeController@add')->name('setups.fee.category.add');
	Route::post('/fee/category/store', 'Backend\Setup\FeeController@store')->name('setups.fee.category.store');
	Route::get('/fee/category/edit/{id}', 'Backend\Setup\FeeController@edit')->name('setups.fee.category.edit');
	Route::post('/fee/category/update/{id}', 'Backend\Setup\FeeController@update')->name('setups.fee.category.update');
...
Route::prefix('students')->group(function(){
   ...
   //Student Attendence
	Route::get('student/attend/view', 'Backend\Student\StudentAttendController@view')->name('students.attendence.view');
    Route::get('student/attend/add', 'Backend\Student\StudentAttendController@add')->name('students.attendence.add');
    Route::post('student/attend/store', 'Backend\Student\StudentAttendController@store')->name('students.attendence.store');
    Route::get('student/attend/edit/{date}', 'Backend\Student\StudentAttendController@edit')->name('students.attendence.edit');
    Route::get('student/attend/datails/{date}', 'Backend\Student\StudentAttendController@datails')->name('students.attendence.datails');

     Route::get('/get-student-attend', 'Backend\Student\StudentAttendController@YearClassWise')->name('get.students.attendence');
   ...
   //Student Registration Fee
    ...
    Route::get('/exam/fee/payslip', 'Backend\Student\ExamFeeController@paySlip')->name('students.exam.fee.payslip');
     ...
     //payMent
    Route::get('/payment/fee/view', 'Backend\Student\PaymentFeeController@view')->name('students.payment.fee.view');
    Route::get('/payment/get-student', 'Backend\Student\PaymentFeeController@getStudent')->name('students.payment.fee.get-student');
    Route::get('/payment/fee/payslip', 'Backend\Student\PaymentFeeController@paySlip')->name('students.payment.fee.payslip');
...
Route::prefix('employees')->group(function(){
    ...
    Route::get('/attend/datails/{date}', 'Backend\Employee\EmployeeAttendController@datails')->name('employees.attendence.datails');
...
Route::prefix('marks')->group(function(){
	...
	Route::get('/marks/get-student-marks', 'Backend\Marks\MarksController@getMarks')->name('marks.get-student-marks');
...
//Check
    Route::get('/result/view', 'Backend\Check\CheckController@view')->name('students.result.view');
    Route::get('/get-student-result', 'Backend\Check\CheckController@YearClassWise')->name('get.students.result');
    

   Route::get('/reg/result/{student_id}', 'Backend\Check\CheckController@result')->name('students.registration.result');
